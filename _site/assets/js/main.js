...
var submitMailChimpForm = function (form) {
  ...
  // Create a global variable for the submit button container
  window.fSubmit = form.querySelector('.f-submit');
