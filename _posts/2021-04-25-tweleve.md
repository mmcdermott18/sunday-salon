...
full: false
number: 12
description: Join us for a panel and group discussion on tenure and the tenure process. We’ll be joined by three awesome panelists who all have recently attained tenure and have graciously offered to talk about their experience navigating the process.
layout: post
...
<article markdown="1">
![Change this File]({{ site.baseurl }}/assets/img/8-drake_01.gif "change this file")
#### Liat Berdugo
...
<article markdown="1">
![Change this File]({{ site.baseurl }}/assets/img/8-drake_02.gif "change this file")
#### Meaghan Dee
...
<article markdown="1">
![Change this File]({{ site.baseurl }}/assets/img/8-drake_03.gif "change this file")
#### Jonathan Hanahan
